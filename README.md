...
1. Create the dataset and convert categorical variables (**Departments, salary**) into numerical form using **one-hot encoding**.
2. Separate the dataset into **features (X)** and **target variable (left)** and perform **train–test split**.
3. Train the **Decision Tree Classifier** using the training data.
4. Predict employee churn and evaluate the model using **confusion matrix, accuracy score**, and **visualize the decision tree**.
...
## Output:
<img width="1174" height="752" alt="image" src="https://github.com/user-attachments/assets/90d55295-4c77-4e31-8316-d25e8920530e" />
